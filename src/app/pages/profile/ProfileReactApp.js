...
(function () {
  ...
  function ProfilePage() {
    ...
    var toggleSwitch = function (index) {
        ...
        return h('div', { className: 'col-md-3 col-sm-4', key: item.name },
          h('a', { className: 'sn-link connected', href: item.href, target: '_blank' },
            ...
            h('em', {
              ...
              onClick: function (e) { e.preventDefault(); e.stopPropagation(); unconnect(i); }
            })
          )
        );
      }
    ...
    function renderSwitch(index, label) {
      return h('div', { className: 'form-group row clearfix', key: index },
        h('label', { className: 'col-xs-8' }, label),
        h('div', { className: 'col-xs-4' },
          h('div', {
            className: 'switch-container primary',
            onClick: function () { toggleSwitch(index); }
          },
            h('input', { type: 'checkbox', checked: switches[index], readOnly: true })
          )
        )
      );
    }
        ...
        h('div', { className: 'panel-body' },
          h('div', { className: 'panel-content' },
                ...
                h('div', { className: 'form-group row clearfix' },
                  ...
                  h('div', { className: 'col-sm-9' },
                    h('div', { className: 'userpic' },
                      ...
                      h('input', { type: 'file', style: { display: 'none' }, id: 'uploadFile' })
                    )
                  )
                )
              ),
            ...
            h('div', { className: 'row' },
              ...
              h('div', { className: 'col-md-6' },
                formGroup('Department', undefined,
                  h('select', { className: 'form-control', defaultValue: 'Web Development' },
            ...
            h('div', { className: 'row' },
              ...
              h('div', { className: 'col-md-6' },
                formGroup('Office Location', undefined,
