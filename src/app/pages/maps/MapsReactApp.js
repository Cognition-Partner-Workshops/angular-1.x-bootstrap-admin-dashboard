/**
 * React migration of BlurAdmin Maps module.
 * Uses React.createElement (no JSX) and UMD React 18 via CDN.
 */
(function () {
  'use strict';
  ...
  // --- Color helper (replicates theme.constants.js mix function) ---
  ...
  var AMMAP_IMAGES_PATH = 'assets/img/theme/vendor/ammap//dist/ammap/images/';

  // --- Panel wrapper component ---
  function PanelWrapper(props) {
    return h('div', { className: 'panel viewport100' },
  ...
  function GoogleMapsPage() {
    ...
    return h(PanelWrapper, { title: 'Google Maps' },
      h('div', { id: 'google-maps', ref: mapRef })
    );
  }

  // --- Leaflet Maps Page ---
  function LeafletMapsPage() {
    var mapRef = React.useRef(null);
    ...
    return h(PanelWrapper, { title: 'Leaflet' },
      h('div', { id: 'leaflet-map', ref: mapRef })
    );
  }

  // --- Map Bubbles Page ---
  function MapBubblesPage() {
    var mapRef = React.useRef(null);
    ...
    React.useEffect(function () {
      ...
      var timer = setTimeout(function () {
        ...
        map.pathToImages = AMMAP_IMAGES_PATH;
    ...
    return h(PanelWrapper, { title: 'Map with Bubbles' },
      h('div', { id: 'map-bubbles', ref: mapRef })
    );
  }

  // --- Map Lines Page ---
  function MapLinesPage() {
    var mapRef = React.useRef(null);
        ...
        AmCharts.makeChart('map-lines', {
          ...
          dataProvider: {
            ...
            images: [{
              ...
              lines: [
                { latitudes: [51.5002, 50.4422], longitudes: [-0.1262, 30.5367] },
                { latitudes: [51.5002, 46.9480], longitudes: [-0.1262, 7.4481] },
                { latitudes: [51.5002, 59.3328], longitudes: [-0.1262, 18.0645] },
                { latitudes: [51.5002, 40.4167], longitudes: [-0.1262, -3.7033] },
                { latitudes: [51.5002, 46.0514], longitudes: [-0.1262, 14.5060] },
                { latitudes: [51.5002, 48.2116], longitudes: [-0.1262, 17.1547] },
                { latitudes: [51.5002, 44.8048], longitudes: [-0.1262, 20.4781] },
                { latitudes: [51.5002, 55.7558], longitudes: [-0.1262, 37.6176] },
                { latitudes: [51.5002, 38.7072], longitudes: [-0.1262, -9.1355] },
                { latitudes: [51.5002, 54.6896], longitudes: [-0.1262, 25.2799] },
                { latitudes: [51.5002, 64.1353], longitudes: [-0.1262, -21.8952] },
                { latitudes: [51.5002, 40.4300], longitudes: [-0.1262, -74.0000] }
              ],
              images: [{
              ...
              lines: [
                ...
                { latitudes: [54.6896, 51.5002], longitudes: [25.2799, -0.1262] },
              ...
              svgPath: targetSVG, title: 'Brussels', latitude: 50.8371, longitude: 4.3676
            }, {
              svgPath: targetSVG, title: 'Prague', latitude: 50.0878, longitude: 14.4205
            }, {
              svgPath: targetSVG, title: 'Athens', latitude: 37.9792, longitude: 23.7166
            }, {
              svgPath: targetSVG, title: 'Reykjavik', latitude: 64.1353, longitude: -21.8952
            }, {
              svgPath: targetSVG, title: 'Dublin', latitude: 53.3441, longitude: -6.2675
            }, {
              svgPath: targetSVG, title: 'Oslo', latitude: 59.9138, longitude: 10.7387
            }, {
              svgPath: targetSVG, title: 'Lisbon', latitude: 38.7072, longitude: -9.1355
            }, {
              svgPath: targetSVG, title: 'Moscow', latitude: 55.7558, longitude: 37.6176
            }, {
              svgPath: targetSVG, title: 'Belgrade', latitude: 44.8048, longitude: 20.4781
            }, {
              svgPath: targetSVG, title: 'Bratislava', latitude: 48.2116, longitude: 17.1547
            }, {
              svgPath: targetSVG, title: 'Ljubljana', latitude: 46.0514, longitude: 14.5060
            }, {
              svgPath: targetSVG, title: 'Madrid', latitude: 40.4167, longitude: -3.7033
            }, {
              svgPath: targetSVG, title: 'Stockholm', latitude: 59.3328, longitude: 18.0645
            }, {
              svgPath: targetSVG, title: 'Bern', latitude: 46.9480, longitude: 7.4481
            }, {
              svgPath: targetSVG, title: 'Kiev', latitude: 50.4422, longitude: 30.5367
            }, {
              svgPath: targetSVG, title: 'Paris', latitude: 48.8567, longitude: 2.3510
            }, {
              svgPath: targetSVG, title: 'New York', latitude: 40.43, longitude: -74
            }]
          },
          areasSettings: { unlistedAreasColor: layoutColors.info },
          imagesSettings: { color: layoutColors.warningLight, selectedColor: layoutColors.warning },
          linesSettings: { color: layoutColors.warningLight, alpha: 0.8 },
          backgroundZoomsToTop: true,
          linesAboveImages: true,
          export: { enabled: true },
          pathToImages: AMMAP_IMAGES_PATH
        });
      }, 100);
    ...
    return h(PanelWrapper, { title: 'Line Map' },
      h('div', { id: 'map-lines', ref: mapRef })
    );
  }

  // --- Minimal Hash Router ---
  var ROUTES = {
    '/maps/gmap': GoogleMapsPage,
    '/maps/leaflet': LeafletMapsPage,
    '/maps/bubble': MapBubblesPage,
    '/maps/line': MapLinesPage
  };
  ...
  function App() {
    var state = React.useState(getHashPath());
    var hashPath = state[0];
    var setHashPath = state[1];
    ...
    var PageComponent = ROUTES[hashPath] || null;
  ...
  // --- Mount / Unmount API ---
  var mountEl = null;
  window.mountMapsReact = function (element) {
    mountEl = element;
    ReactDOM.render(h(App), element);
  };
  window.unmountMapsReact = function () {
    if (mountEl) {
