...
export function AmChartsPage({ baConfig }) {
  ...
  useEffect(function () {
    ...
    AmCharts.makeChart('barChart', {
      ...
      valueAxes: [{
        axisAlpha: 0, position: 'left', title: 'Visitors from country',
        gridAlpha: 0.5, gridColor: layoutColors.border
      }],
      startDuration: 1,
      graphs: [{
        balloonText: '<b>[[category]]: [[value]]</b>',
        fillColorsField: 'color', fillAlphas: 0.7, lineAlpha: 0.2,
        type: 'column', valueField: 'visits'
      }],
    ...
    var areaChart = AmCharts.makeChart('areaChart', {
      ...
      graphs: [{
        bullet: 'square', bulletBorderAlpha: 1, bulletBorderThickness: 1,
        fillAlphas: 0.5, fillColorsField: 'lineColor',
        legendValueText: '[[value]]', lineColorField: 'lineColor',
        title: 'duration', valueField: 'duration'
      }],
      chartCursor: {
        categoryBalloonDateFormat: 'YYYY MMM DD',
        cursorAlpha: 0, fullWidth: true
      },
      ...
      categoryAxis: {
        ...
        parseDates: true, autoGridCount: false, gridCount: 50,
        gridAlpha: 0.5, gridColor: layoutColors.border
      },
      export: { enabled: true },
      pathToImages: AMCHART_IMAGES
    ...
    var lineChart = AmCharts.makeChart('lineChart', {
      ...
      graphs: [{
        id: 'g1', balloonText: '[[value]]',
        bullet: 'round', bulletSize: 8,
        lineColor: layoutColors.danger, lineThickness: 1,
        negativeLineColor: layoutColors.warning,
        type: 'smoothedLine', valueField: 'value'
      }],
      chartScrollbar: {
        graph: 'g1', gridAlpha: 0,
        color: layoutColors.defaultText, scrollbarHeight: 55,
        backgroundAlpha: 0, selectedBackgroundAlpha: 0.05,
        selectedBackgroundColor: layoutColors.defaultText,
        graphFillAlpha: 0, autoGridCount: true,
        selectedGraphFillAlpha: 0, graphLineAlpha: 0.2,
        selectedGraphLineColor: layoutColors.defaultText,
        selectedGraphLineAlpha: 1
      },
      chartCursor: {
        categoryBalloonDateFormat: 'YYYY',
        cursorAlpha: 0, valueLineEnabled: true,
        valueLineBalloonEnabled: true, valueLineAlpha: 0.5,
        fullWidth: true
      },
      dataDateFormat: 'YYYY',
      categoryField: 'year',
      categoryAxis: {
        minPeriod: 'YYYY', parseDates: true,
        minorGridAlpha: 0.1, minorGridEnabled: true,
        gridAlpha: 0.5, gridColor: layoutColors.border
      },
      export: { enabled: true },
    ...
    pieChart.addListener('init', function () {
      pieChart.legend.addListener('rollOverItem', function (e) {
    ...
    AmCharts.makeChart('zoomAxisChart', {
      ...
      valueAxes: [
        {
          ...
          id: 'v1', title: 'Sales', position: 'left',
          autoGridCount: false,
        ...
        },
        {
          ...
          axisColor: layoutColors.defaultText,
          gridColor: layoutColors.defaultText,
          id: 'v2', title: 'Market Days', gridAlpha: 0,
          position: 'right', autoGridCount: false
        }
      ],
      graphs: [
        {
          id: 'g3', color: layoutColors.defaultText,
          valueAxis: 'v1', lineColor: layoutColors.primaryLight,
          fillColors: layoutColors.primaryLight,
          fillAlphas: 0.8, lineAlpha: 0.8, type: 'column',
          title: 'Actual Sales', valueField: 'sales2',
          clustered: false, columnWidth: 0.5,
        ...
        },
        {
          ...
          fillAlphas: 0.9, lineAlpha: 0.9, type: 'column',
          title: 'Target Sales', valueField: 'sales1',
          clustered: false, columnWidth: 0.3,
          legendValueText: '$[[value]]M',
          balloonText: "[[title]]<br/><b style='font-size: 130%'>$[[value]]M</b>"
        },
        {
          id: 'g1', valueAxis: 'v2', bullet: 'round',
          bulletBorderAlpha: 1, bulletColor: layoutColors.defaultText,
          color: layoutColors.defaultText, bulletSize: 5,
          hideBulletsCount: 50, lineThickness: 2,
          lineColor: layoutColors.danger, type: 'smoothedLine',
          title: 'Market Days', useLineColorForBulletBorder: true,
          valueField: 'market1',
        ...
        },
        {
          ...
          bulletColor: layoutColors.defaultText, bulletSize: 5,
          hideBulletsCount: 50, lineThickness: 2,
          lineColor: layoutColors.warning, type: 'smoothedLine',
          dashLength: 5, title: 'Market Days ALL',
          useLineColorForBulletBorder: true, valueField: 'market2',
          balloonText: "[[title]]<br/><b style='font-size: 130%'>[[value]]</b>"
        }
      ],
      chartScrollbar: {
        graph: 'g1', oppositeAxis: false, offset: 30,
        gridAlpha: 0, color: layoutColors.defaultText,
        scrollbarHeight: 50, backgroundAlpha: 0,
      ...
      chartCursor: {
        pan: true, cursorColor: layoutColors.danger,
        valueLineEnabled: true, valueLineBalloonEnabled: true,
        cursorAlpha: 0, valueLineAlpha: 0.2
      },
      categoryField: 'date',
      categoryAxis: {
        axisColor: layoutColors.defaultText,
        color: layoutColors.defaultText,
        gridColor: layoutColors.defaultText,
        parseDates: true, dashLength: 1,
        minorGridEnabled: true
      },
      legend: {
        useGraphSettings: true, position: 'top',
        color: layoutColors.defaultText
      },
