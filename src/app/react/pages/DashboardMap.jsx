/**
 * DashboardMap — React port of the AngularJS dashboard-map directive
 * (DashboardMapCtrl + dashboardMap.html). The "Users by Country" widget.
 *
 * Renders an AmCharts world map into #amChartMap.
 */
import React, { useRef, useEffect } from 'react';

export function DashboardMap({ baConfig, layoutPaths }) {
  ...
  useEffect(function () {
    ...
    mapRef.current = AmCharts.makeChart('amChartMap', {
      type: 'map',
      theme: 'blur',
    ...
    return function () {
      if (mapRef.current && typeof mapRef.current.clear === 'function') {
