/**
 * Shared datasets for the migrated Tables module (basic + smart pages).
 *
 * Ported verbatim from src/app/pages/tables/TablesPageCtrl.js so the React
 * components render identical data to the original AngularJS controller.
 */

export var smartTableData = [
...
export var editableTableData = smartTableData.slice(0, 36);

export var peopleTableData = [
...
// Contextual + responsive tables render the first five smartTableData rows.
export var contextualRowClasses = ['primary', 'success', 'warning', 'danger', 'info'];
export var basicPeopleData = smartTableData.slice(0, 5);
...
export var usersData = [
  ...
  { id: 4, name: 'Buckley Hopkins', group: 4 },
...
// Equivalent of the AngularJS appImage filter: layoutPaths.images.root + input.
export function appImage(input) {
