  ...
  return React.createElement('div', { className: 'widgets' },
    React.createElement('div', { className: 'row' },
      React.createElement('div', { className: 'col-md-12' },
        React.createElement(Panel, { title: 'Inline Form', panelClass: 'with-scroll', baPanelTitle: 'Inline Form' },
    ...
    React.createElement('div', { className: 'row' },
      React.createElement('div', { className: 'col-md-6' },
        React.createElement(Panel, { title: 'Basic Form', panelClass: 'with-scroll', baPanelTitle: 'Basic Form' },
          React.createElement(BasicForm)
        ),
        React.createElement(Panel, { title: 'Horizontal Form', panelClass: 'with-scroll', baPanelTitle: 'Horizontal Form' },
          React.createElement(HorizontalForm)
        )
      ),
      React.createElement('div', { className: 'col-md-6' },
        React.createElement(Panel, { title: 'Form Without Labels', panelClass: 'with-scroll', baPanelTitle: 'Form Without Labels' },
          React.createElement(FormWithoutLabels)
        ),
        React.createElement(Panel, { title: 'Block Form', panelClass: 'with-scroll', baPanelTitle: 'Block Form' },
