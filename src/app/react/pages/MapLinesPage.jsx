/**
 * MapLinesPage — React port of MapLinesPageCtrl + map-lines.html.
 *
 * Builds an amCharts world map with flight lines. The amCharts global
 * (window.AmCharts) is loaded by the host page; theme colors and asset paths
...
export function MapLinesPage({ baConfig, layoutPaths }) {
  useEffect(function () {
    ...
    var chartTimer = setTimeout(function () {
            chart = AmCharts.makeChart( 'map-lines', {
              type: 'map',
              theme: 'blur',
              dataProvider: {
                map: 'worldLow',
