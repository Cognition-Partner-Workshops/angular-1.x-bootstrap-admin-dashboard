/**
 * DashboardLineChart — React port of the AngularJS dashboard-line-chart directive
 * (DashboardLineChartCtrl + dashboardLineChart.html). The "Revenue" widget.
 *
 * Renders an AmCharts serial chart into #amchart.
 */
import React, { useRef, useEffect } from 'react';

export function DashboardLineChart({ baConfig, layoutPaths, baUtil }) {
  ...
  useEffect(function () {
    ...
    return function () {
      if (chartRef.current && typeof chartRef.current.clear === 'function') {
