...
export interface PersonRow extends TableRow {
  status: string;
}
...
export const METRICS_TABLE_DATA: MetricsRow[] = [
...
export const SMART_TABLE_PAGE_SIZE = 10;
export const SMART_TABLE_PAGE_SIZES = [5, 10, 15, 20, 25];
