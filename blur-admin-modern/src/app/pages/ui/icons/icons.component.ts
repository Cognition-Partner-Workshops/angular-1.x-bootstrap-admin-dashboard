...
type KameleonIcon = { name: string; img: string };
type KameleonRoundedIcon = KameleonIcon & { color: string };

@Component({
  selector: 'app-icons',
  standalone: true,
  imports: [BaPanelComponent, KameleonImgPipe, NgClass, NgFor, NgTemplateOutlet],
  templateUrl: './icons.component.html',
  styleUrl: './icons.component.scss',
  encapsulation: ViewEncapsulation.None,
})
export class IconsComponent {
  readonly kameleonIcons: readonly KameleonIcon[] = [
    ...
    { name: 'Euro', img: 'Euro-Coin' }, { name: 'Chessboard', img: 'Chessboard' }, { name: 'Burglar', img: 'Burglar' },
    { name: 'Dna', img: 'Dna' }, { name: 'Clipboard Plan', img: 'Clipboard-Plan' }, { name: 'Boss', img: 'Boss-3' },
    { name: 'Key', img: 'Key' }, { name: 'Surgeon', img: 'Surgeon' }, { name: 'Hacker', img: 'Hacker' },
    { name: 'Santa', img: 'Santa' },
  ];
  readonly kameleonRoundedIcons: readonly KameleonRoundedIcon[] = [
    { color: 'success', img: 'Apartment', name: 'Apartment' }, { color: 'warning', img: 'Bus', name: 'Bus' },
    { color: 'primary', img: 'Checklist', name: 'Checklist' }, { color: 'warning', img: 'Desert', name: 'Desert' },
    { color: 'danger', img: 'Laptop-Signal', name: 'Laptop Signal' }, { color: 'info', img: 'Love-Letter', name: 'Love Letter' },
    { color: 'success', img: 'Makeup', name: 'Makeup' }, { color: 'primary', img: 'Santa', name: 'Santa' },
    { color: 'success', img: 'Surfer', name: 'Surfer' }, { color: 'info', img: 'Vector', name: 'Vector' },
    { color: 'warning', img: 'Money-Increase', name: 'Money Increase' }, { color: 'info', img: 'Alien', name: 'Alien' },
    { color: 'danger', img: 'Online-Shopping', name: 'Online Shopping' }, { color: 'warning', img: 'Euro-Coin', name: 'Euro' },
