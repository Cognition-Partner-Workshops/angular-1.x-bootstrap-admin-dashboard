...
export interface MapOrigin extends MapCity {
  id: 'london' | 'vilnius';
  zoomLevel: number;
  zoomLongitude: number;
  zoomLatitude: number;
...
export const CITIES: [MapOrigin, MapOrigin, ...MapCity[]] = [
  {
    id: 'london', title: 'London', latitude: 51.5002, longitude: -0.1262, scale: 1.5,
    zoomLevel: 2.74, zoomLongitude: -20.1341, zoomLatitude: 49.1712,
    lines: [
  ...
  {
    id: 'vilnius', title: 'Vilnius', latitude: 54.6896, longitude: 25.2799, scale: 1.5,
    zoomLevel: 4.92, zoomLongitude: 15.4492, zoomLatitude: 50.2631,
    lines: [
  ...
  { title: 'Ljubljana', latitude: 46.0514, longitude: 14.5060 },
  { title: 'Madrid', latitude: 40.4167, longitude: -3.7033 },
  { title: 'Stockholm', latitude: 59.3328, longitude: 18.0645 },
  { title: 'Bern', latitude: 46.9480, longitude: 7.4481 },
  { title: 'Kiev', latitude: 50.4422, longitude: 30.5367 },
  { title: 'Paris', latitude: 48.8567, longitude: 2.3510 },
  { title: 'New York', latitude: 40.43, longitude: -74 },
];

export const ORIGINS: Record<'london' | 'vilnius', MapOrigin> = {
  london: CITIES[0],
  vilnius: CITIES[1],
};
