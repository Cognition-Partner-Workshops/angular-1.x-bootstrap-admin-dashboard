...
import { AppImagePipe, ProfilePicturePipe, TrackWidthDirective } from '../../../theme';

export type FeedMessageType = 'text-message' | 'video-message' | 'image-message' | 'geo-message';
...
@Component({
  selector: 'blur-feed',
  standalone: true,
  imports: [AppImagePipe, ProfilePicturePipe, TrackWidthDirective],
  templateUrl: './blur-feed.component.html',
  styleUrl: './blur-feed.component.scss',
  encapsulation: ViewEncapsulation.None,
})
export class BlurFeedComponent {
  readonly smallContainerWidth = signal(false);

  readonly feed: FeedMessage[] = [
    {
      type: 'text-message',
      author: 'Kostya',
      surname: 'Danovsky',
